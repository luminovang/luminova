...
class Container_ac385480e8 extends _PHPStan_8c645376c\Nette\DI\Container
{
	protected $tags = [
	...
	protected $wiring = [
		...
		'Luminova\Debugger\PHPStanRules' => [['0405']],
	];
	...
	public function createService049(): PHPStan\Analyser\ResultCache\ResultCacheManagerFactory
	{
		return new class ($this) implements PHPStan\Analyser\ResultCache\ResultCacheManagerFactory {
			...
			public function __construct(Container_ac385480e8 $container)
			{
	...
	public function createService0405(): Luminova\Debugger\PHPStanRules
	{
	...
	public function createServiceContainer(): Container_ac385480e8
	{
		return $this;
	}
