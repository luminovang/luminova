...
<header>
    ...
    <div class="menu">
        <ul>
            ...
            <li class="menu-item hidden"><a href="https://luminova.ng/">Home</a></li>
        ...
        <div class="container main-container">
            <div class="tab-content">
                <div class="info-tab-buttons">
                    <ul>
                        <li class="info-trigger active" data-target="#constants">
                            <span>CONSTANTS</span>
                        </li>
                        <li class="info-trigger" data-target="#server">
                            <span>SERVER</span>
                        </li>
                        <li class="info-trigger" data-target="#memory">
                            <span>memory</span>
                        </li>
                    </ul>
                </div>
                <div class="info-tab-contents">
                    ...
                    <div class="content active" id="constants">
...
<script>
    ...
    document.querySelectorAll('.info-trigger').forEach(function(trigger) {
        trigger.addEventListener('click', function() {
            document.querySelectorAll('.info-trigger').forEach(function(t) {
                t.classList.remove('active');
            });
            document.querySelectorAll('.info-tab-contents .content').forEach(function(content) {
