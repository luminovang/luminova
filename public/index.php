 ...
 *  - @param string $name Route URI prefix name, any url that starts 
 *      with $name will be routed to name.php in routes/name.php.
 ...
 *              fn(Application $app): int => App\Errors\Controllers\AppError::onWebError($app))
 ...
 *              [App\Errors\Controllers\AppError::class, 'handlerMethod']
 * 
 * 
 ...
 *              [
 *                   'prefix' => 'foo', 
 *                   'error' => [App\Errors\Controllers\AppError::class, 'onFooError'] 
 *               ]
 * 
...
//    new Prefix(Prefix::WEB, [AppError::class, 'onWebError']),
//    new Prefix(Prefix::API, [AppError::class, 'onApiError']),
